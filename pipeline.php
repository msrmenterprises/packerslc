...
<head>
    ...
    <title>Packers LC - Pipeline SCADA</title>
    <!-- Favicon -->
        ...
        <div class="row align-items-center">
            <div class="col-xl-6 col-lg-6">
                <div class="about-img-wrap">
                    <div class="image-one">
                        <img src="images/PIPELINE_SCADA.jpg" alt="">
                    </div>                        
                </div>
            </div>
            <div class="col-xl-6 col-lg-6">
                <div class="about-content-wrap">
                    <div class="section-title">
                        <h2>PIPELINE SCADA</h2>
                    </div>
                    <p>We deliver advanced SCADA systems for real-time monitoring and
control of pipeline operations, enhancing safety, efficiency, and data-driven
decision-making.
</p>
