...
<head>
    ...
    <title>Packers LC - Pipes and Fittings</title>
    <!-- Favicon -->
            ...
            <div class="col-xl-6 col-lg-6">
                <div class="about-content-wrap">
                    ...
                    <ul class="about-key mt-30">
                        ...
                        <li><i class="las la-check-square"></i><p>Specialized Fittings</p></li>
                    </ul>
                </div>
        ...
        <div class="row align-items-center mt-120">
            <div class="col-12">
                <div class="client-wrap owl-carousel">
                    ...
                    <div class="single-client"><a href="#"><img src="images/tyco_fire.png" alt="Tyco Fire"></a></div>
                </div>
            </div>
        </div>
    </div>
