...
<head>
    ...
    <title>Packers LC - Heat Exchanger</title>
    <!-- Favicon -->
        ...
        <div class="row align-items-center">
            ...
            <div class="col-xl-6 col-lg-6">
                <div class="about-content-wrap">
                    ...
                    <p>We provide high-quality spares for heat exchangers from trusted brands to ensure efficient thermal performance and longevity. These parts are designed to meet rigorous standards for reliability in demanding applications.
                    </p>
        ...
        <div class="row align-items-center mt-120">
            ...
            <div class="col-12">
                <div class="client-wrap owl-carousel">
                    <div class="single-client"><a href="#"><img src="images/HEATEXCHANGER/BRANDS/tranter.png" alt="tranter"></a></div>
                    <div class="single-client"><a href="#"><img src="images/HEATEXCHANGER/BRANDS/WCR.png" alt="WCR"></a></div>
