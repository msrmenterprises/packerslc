...
<head>
    ...
    <title>Max Lambda - Turbine/Engine Repair and Spares</title>
    <!-- Favicon -->
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6 text-center">
                <div class="breadcrumb-title">
                    <h1>TURBINE/ENGINE REPAIR AND SPARES</h1>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row align-items-center">
            <div class="col-xl-6 col-lg-6">
                <div class="about-img-wrap">
                    <div class="image-one">
                        <img src="images/TURBINE_Engone.jpg" alt="">
                    </div>                        
                </div>
            </div>
            <div class="col-xl-6 col-lg-6">
                <div class="about-content-wrap">
                    <div class="section-title">
                        <h2>TURBINE/ENGINE REPAIR AND SPARES</h2>
                    </div>
                    <p>Our expert technicians offer repair services and genuine spare parts
for turbines and engines, minimizing downtime and optimizing performance
