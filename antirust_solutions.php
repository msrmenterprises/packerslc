...
<head>
    ...
    <title>Packers LC - Antirust</title>
    <!-- Favicon -->
        ...
        <div class="navigation">
            <div class="container">
                <div class="header-inner-box">
                    <div class="logo"><a class="navbar-brand" href="index">Packers LC</a></div>
            ...
            <div class="col-xl-6 col-lg-6">
                <div class="about-content-wrap">
                    <div class="section-title">
                        <h2>ANTIRUST SOLUTIONS</h2>
                    </div>
                    <p>We provide reliable anti-rust solutions from trusted brands to ensure superior protection against corrosion. These products are designed to enhance durability and performance across various applications
                    .
